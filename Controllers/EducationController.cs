...
namespace Portfolio.Controllers
{
    public class EducationController : Controller
    {
        ...
        {
            ViewBag.StudentProfiledId = new SelectList(db.StudentProfile, "Id", "FullName");
            return View();
        ...
        public ActionResult Create(Education edu)
        {
            ...
            ViewBag.StudentProfiledId = new SelectList(db.StudentProfile, "Id", "FullName", edu.StudentProfileId);
            return View(edu);
